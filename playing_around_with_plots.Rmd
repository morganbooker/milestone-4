...
cm_1x01 <- paste(readLines("cm_1x01.txt"))
...
cm_2x01 <- paste(readLines("cm_2x01.txt"))
...
cm_3x01 <- paste(readLines("cm_3x01.txt"))
...
cm_4x01 <- paste(readLines("cm_4x01.txt"))
...
cm_5x01 <- paste(readLines("cm_5x01.txt"))
